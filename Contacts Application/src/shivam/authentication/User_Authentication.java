package shivam.authentication;

import shivam.database.Connect_to_DB;
...
public class User_Authentication {
    ...
    public static String addUser(String name,String email,String pass){
        ...
        try {
            ...
            resultSet=statement.executeQuery("SELECT * from USER where uemail='"+email+"';");
            if (resultSet.next()){
                return "User already registered ! Try login.";
            }else{

                statement.execute("INSERT INTO USER(uname,upass,uemail) VALUES('"+name+"','"+pass+"','"+email+"');");
